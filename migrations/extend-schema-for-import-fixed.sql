...
-- ============================================
-- VERSIÓN CORREGIDA - Maneja triggers y políticas existentes
...
ALTER TABLE public.sold_trips
  ...
  ADD COLUMN IF NOT EXISTS group_split_method TEXT,
...
-- ============================================
DROP POLICY IF EXISTS "Authenticated users can view client payment plans" ON public.client_payment_plans;
DROP POLICY IF EXISTS "Authenticated users can insert client payment plans" ON public.client_payment_plans;
DROP POLICY IF EXISTS "Authenticated users can update client payment plans" ON public.client_payment_plans;
DROP POLICY IF EXISTS "Authenticated users can view trip notes" ON public.trip_notes;
DROP POLICY IF EXISTS "Authenticated users can insert trip notes" ON public.trip_notes;
DROP POLICY IF EXISTS "Authenticated users can update trip notes" ON public.trip_notes;
DROP POLICY IF EXISTS "Authenticated users can view trip document files" ON public.trip_document_files;
DROP POLICY IF EXISTS "Authenticated users can insert trip document files" ON public.trip_document_files;
DROP POLICY IF EXISTS "Authenticated users can update trip document files" ON public.trip_document_files;
DROP POLICY IF EXISTS "Authenticated users can view travel documents" ON public.travel_documents;
DROP POLICY IF EXISTS "Authenticated users can insert travel documents" ON public.travel_documents;
DROP POLICY IF EXISTS "Authenticated users can update travel documents" ON public.travel_documents;
...
-- ============================================
DROP TRIGGER IF EXISTS update_client_payment_plans_updated_date ON public.client_payment_plans;
DROP TRIGGER IF EXISTS update_trip_notes_updated_date ON public.trip_notes;
DROP TRIGGER IF EXISTS update_trip_document_files_updated_date ON public.trip_document_files;
DROP TRIGGER IF EXISTS update_travel_documents_updated_date ON public.travel_documents;

-- ============================================
-- CREAR TRIGGERS PARA UPDATED_DATE
-- ============================================
