    ...
    <section className="flex flex-col items-center justify-center h-full">
      ...
      <p className="text-gray-500 mt-12">
        Presentación confidencial - 2025
            ...
            {
                path: "/styles.css",
                content: `@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700;900&display=swap');
...
.reveal section {
  ...
  "devDependencies": {}
        ...
        console.log("✅ Plantilla 'Pitch Deck Startup' creada exitosamente");

        // Template 2: Presentación Técnica
        const technicalId = await ctx.db.insert("templates", {
      ...
      <ul className="text-2xl space-y-6 max-w-3xl">
        ...
        <li className="fragment flex items-start gap-4">
          ...
          <span>Demo en vivo</span>
            ...
            {
                path: "/slides/ArchitectureSlide.js",
                content: `import React from "react";
      ...
      <div className="grid grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        <div className="fragment bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-6 rounded-xl">
          ...
          <ul className="text-lg space-y-2">
            ...
            {
                path: "/slides/CodeExampleSlide.js",
                content: `import React from "react";
...
export default function CodeExampleSlide() {
  return (
    <section>
      ...
      <pre className="text-left"><code className="language-javascript">{\`// Controlador de usuario con async/await
      ...
      <div className="text-left max-w-4xl mx-auto space-y-4 text-lg font-mono">
        ...
        <div className="fragment bg-red-500/20 p-4 rounded-lg">
          ...
          <p className="text-gray-400 text-sm mt-1">Eliminar usuario</p>
            ...
            {
                path: "/slides/PerformanceSlide.js",
                content: `import React from "react";
    ...
    <section className="flex flex-col items-center justify-center h-full">
      ...
      <div className="text-xl text-gray-500">
        ...
        <p>📚 docs.empresa.com</p>
            ...
            {
                path: "/styles.css",
                content: `@import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;700&family=Inter:wght@300;400;600;700;900&display=swap');
...
.reveal section {
  ...
  "devDependencies": {}
        ...
        for (const file of technicalFiles) {
            await ctx.db.insert("templateFiles", {
                templateId: technicalId,
                path: file.path,
                content: file.content
            });
        }

        console.log("✅ Plantilla 'Presentación Técnica' creada exitosamente");

        return {
            success: true,
            templates: [
                { id: pitchDeckId, name: "Pitch Deck Startup" },
                { id: technicalId, name: "Presentación Técnica" }
            ]
        };
    }
});
