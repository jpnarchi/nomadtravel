...
export const SignUpView = () => {
    return (
        ...
        >
            ...
            <div className="absolute left-0 top-0 w-full h-full md:w-1/2 flex items-center justify-center p-8 z-10 pt-10 lg:pt-30 -ml-3 md:ml-0">
                <div className="w-full max-w-md space-y-4">
                    <h1 className="text-4xl lg:text-5xl font-semibold text-black -mb-2 ml-4">Sign up</h1>
                    <SignUp
                        routing="path"
                        path="/sign-up"
                        appearance={{
