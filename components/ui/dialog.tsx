...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center sm:text-left pointer-events-auto", className)}
      {...props}
    />
  )
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end pointer-events-auto",
        className
      )}
      {...props}
    />
